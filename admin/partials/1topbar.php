            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                            <h6 class="preview-subject font-weight-normal mb-1">contoh notifikasi 1</h6>
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                            <h6 class="preview-subject font-weight-normal mb-1">Contoh Notifikasi 2</h6>
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                            <h6 class="preview-subject font-weight-normal mb-1">Conttoh Notifikasi 3</h6>
                            <p class="text-gray ellipsis mb-0"> ........... </p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
