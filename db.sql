...
INSERT INTO `notifikasi` (`id`, `user_id`, `judul`, `pesan`, `icon`, `warna`, `status`, `created_at`) VALUES
	(2, 2, 'Status Laporan Diperbarui', 'Laporan fasilitas Anda kini berstatus: <b>Diajukan</b>.', 'settings', 'info', 'belum_dibaca', '2025-04-05 10:41:46');
...
INSERT INTO `pembayaran` (`id`, `mahasiswa_id`, `kamar_id`, `bulan`, `jumlah`, `status`, `bukti_pembayaran`, `created_at`, `updated_at`) VALUES
	(1, 2, 25, '2025-04', 250000.00, 'verified', '1743813928_lhkpn.pdf', '2025-04-02 09:13:16', '2025-04-05 00:51:47');
...
INSERT INTO `users` (`id`, `id_kamar`, `nama`, `nim`, `tempat_lahir`, `tanggal_lahir`, `jurusan`, `fakultas`, `no_hp`, `email`, `password`, `level`) VALUES
	...
	(2, '25', 'Yunita Dwi Ariatna Pua', '20210107', 'Lopana', '2003-06-16', 'Teknik Informatika', 'Fakultas Teknik', '0987654321', 'yunitapua79@gmail.com', '$2y$10$fiQTXRGPMNmqGRxOQB58Ju2E8q607D50fQydNBhaMgcGZgjLO5Md6', NULL),
